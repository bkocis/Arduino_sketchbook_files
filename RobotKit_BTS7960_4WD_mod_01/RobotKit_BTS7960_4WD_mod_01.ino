...
const int F_MotorRight_R_EN = 12; // Pin to control the clockwise direction of Right Motor
const int F_MotorRight_L_EN = 13; // Pin to control the counterclockwise direction of Right Motor 
...
const int B_Rpwm2 = 42; // pwm output - motor A
const int B_Lpwm2 = 43; // pwm output - motor B
